...
mypalette <- colorNumeric( palette="viridis", domain=crm$Prevov, na.color="transparent")
mytext <- paste(
    "Canton: ",crm$NOM_CANT,"<br/>",
    "District: ",crm$NOM_DIST,"<br/>",
    "Value: ", round(crm$Prevov,2), "<br/>",
    "n: ", crm$nov, "<br/>",
    "N: ", crm$N, "<br/>",
    sep="") %>%
  lapply(htmltools::HTML)
...
mypalette <- colorNumeric( palette="viridis", domain=crm$Prevob, na.color="transparent")
mytext <- paste(
    "Canton: ",crm$NOM_CANT,"<br/>",
    "District: ",crm$NOM_DIST,"<br/>",
    "Value: ", round(crm$Prevob,2), "<br/>",
    "n: ", crm$nob, "<br/>",
    "N: ", crm$N, "<br/>",
    sep="") %>%
  lapply(htmltools::HTML)
...
#1 - inla.pmarginal(q = 0.3, marginal = marg)
excl <- sapply(fit$marginals.fitted.values,
FUN = function(marg){1 - inla.pmarginal(q = 0.18, marginal = marg)})
excm <- sapply(fit$marginals.fitted.values,
FUN = function(marg){1 - inla.pmarginal(q = 0.2, marginal = marg)})
excu <- sapply(fit$marginals.fitted.values,
FUN = function(marg){1 - inla.pmarginal(q = 0.22, marginal = marg)})
...
### Exceedence probability (0.18 prevalence)
```{r echo=FALSE, include=FALSE}
mypalette <- colorNumeric( palette="viridis", domain=c(0,1), na.color="transparent")
mytext <- paste(
    "Canton: ",mdata$NOM_CANT,"<br/>",
...
### Exceedence probability (0.20 prevalence)
```{r echo=FALSE}
mypalette <- colorNumeric( palette="viridis", domain=c(0,1), na.color="transparent")
mytext <- paste(
    "Canton: ",mdata$NOM_CANT,"<br/>",
...
### Exceedence probability (0.22 prevalence)
```{r echo=FALSE, include=FALSE}
mypalette <- colorNumeric( palette="viridis", domain=c(0,1), na.color="transparent")
mytext <- paste(
    "Canton: ",mdata$NOM_CANT,"<br/>",
...
#1 - inla.pmarginal(q = 0.3, marginal = marg)
excl <- sapply(fit$marginals.fitted.values,
FUN = function(marg){1 - inla.pmarginal(q = 0.11, marginal = marg)})
excm <- sapply(fit$marginals.fitted.values,
FUN = function(marg){1 - inla.pmarginal(q = 0.14, marginal = marg)})
excu <- sapply(fit$marginals.fitted.values,
FUN = function(marg){1 - inla.pmarginal(q = 0.17, marginal = marg)})
...
### Exceedence probability (0.11 prevalence)
```{r echo=FALSE, include=FALSE}
mypalette <- colorNumeric( palette="viridis", domain=c(0,1), na.color="transparent")
mytext <- paste(
    "Canton: ",mdata$NOM_CANT,"<br/>",
...
### Exceedence probability (0.14 prevalence)
```{r echo=FALSE}
mypalette <- colorNumeric( palette="viridis", domain=c(0,1), na.color="transparent")
mytext <- paste(
    "Canton: ",mdata$NOM_CANT,"<br/>",
...
### Exceedence probability (0.17 prevalence)
```{r eval=FALSE, include=FALSE}
mypalette <- colorNumeric( palette="viridis", domain=c(0,1), na.color="transparent")
mytext <- paste(
    "Canton: ",mdata$NOM_CANT,"<br/>",
